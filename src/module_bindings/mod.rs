...
pub use user_cursor_type::UserCursor;
pub use user_info_table::*;
pub use user_info_type::UserInfo;
    ...
    fn try_from(raw: __ws::v2::TransactionUpdate) -> Result<Self, Self::Error> {
        ...
        for table_update in __sdk::transaction_update_iter_table_updates(raw) {
            match &table_update.table_name[..] {
                ...
                "user_cursor" => db_update
                    .user_cursor
                    .append(user_cursor_table::parse_table_update(table_update)?),
                "user_info" => db_update
                    .user_info
                    .append(user_info_table::parse_table_update(table_update)?),
...
impl<'r> __sdk::AppliedDiff<'r> for AppliedDiff<'r> {
    fn invoke_row_callbacks(
        ...
        callbacks.invoke_table_row_callbacks::<UserCursor>("user_cursor", &self.user_cursor, event);
        callbacks.invoke_table_row_callbacks::<UserInfo>("user_info", &self.user_info, event);
    }
}
