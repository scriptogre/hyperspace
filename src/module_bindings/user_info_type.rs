...
impl __sdk::InModule for UserInfo {
    type Module = super::RemoteModule;
}

/// Column accessor struct for the table `UserInfo`.
///
...
impl __sdk::__query_builder::HasCols for UserInfo {
...
/// Indexed column accessor struct for the table `UserInfo`.
///
...
impl __sdk::__query_builder::CanBeLookupTable for UserInfo {}
